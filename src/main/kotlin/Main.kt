...
fun main(args: Array<String>) {
    ...
    val greaterVal = x findGreaterValue y   // x.findGreaterValue(y),
                                            // advantage of infix keyword we can call -> x findGreaterValue y
    println(greaterVal)

}


infix fun Int.findGreaterValue(other: Int): Int {  // INFIX and Extension Func because only one parameter
